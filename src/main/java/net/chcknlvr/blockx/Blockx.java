...
public class Blockx implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        Registry.register(Registry.ITEM, new Identifier("blockx", "wolframite_block"), new BlockItem(WOLFRAMITE, new FabricItemSettings().group(Blockx.BLOCKX).fireproof()));
        Registry.register(Registry.BLOCK, new Identifier("blockx", "tungsten_block"), TUNGSTEN_BLOCK);
        Registry.register(Registry.ITEM, new Identifier("blockx", "tungsten_block"), new BlockItem(TUNGSTEN_BLOCK, new FabricItemSettings().group(Blockx.BLOCKX).fireproof()));
